...
namespace BloodHunt
{
    class Program
    {
        ...
        public static float FMinimalViewInfo_AspectRatio = 0;
        public static float CurrentActorHP = 0;
        public static float CurrentActorHPMax = 0;
        public static float RadFOV = 0;
        ...
        class Components
        {
            ...
            public static class AimbotComponent
            {
                ...
                public static readonly MenuSlider AimFov = new MenuSlider("aimfov", "Aimbot FOV", 1, 1, 1000);
                public static readonly MenuSlider FOV = new MenuSlider("fov", "FOV", (int)0.1f, (int).01f, (int)10.0f);
        ...
        public static void InitializeMenu()
        {
            ...
            RootMenu = new WeScript.SDK.UI.Menu("BloodHunt", "WeScript.app BloodHunt --Poptart--", true)
            {
        ...
        {
            Console.WriteLine("BloodHunt Assembly by Poptart");
            InitializeMenu();
        ...
        private static void OnTick(int counter, EventArgs args)
        {
            ...
            {
                wndHnd = Memory.FindWindowName("Tiger - 64  ");
            ...
            else
            {
                ...
                if (wndHnd != IntPtr.Zero)
                {
                    ...
                    if (GameBase == IntPtr.Zero)
                    {
                        ...
                        Console.WriteLine("Got GAMEBASE of BloodHunt!");
                    }
                    else
                    {
        ...
        private static void OnRenderer(int fps, EventArgs args)
        {
            ...
            {
                Functions.Ppc();
                FMinimalViewInfo_FOV = (2 * Functions.Rad2Deg(Functions.atanf(wndSize.X * (float)0.43 / RadFOV)));
                            ...
                            {                                                                   
                                ...
                                if (USceneComponent != IntPtr.Zero)
                                {
                                    ...
                                    if ((AActorID > 0))
                                    {
                                        ...
                                        if (retname.Contains("TBP_Player_C") || retname.Contains("TBP_ElysiumPlayer_C") || retname.Contains("TBP_NPC_Primogen_C") || retname.Contains("TBP_NPC_C_")) EnemyID = AActorID;
                                    ...
                                    if (Components.VisualsComponent.DrawTheVisuals.Enabled)
                                    {
                                        ...
                                        //Console.WriteLine(tempVec);


                                        if (AActorID == EnemyID && dist > 5 && CurrentActorHP > 0)
                                        {
